$(function () {
    ...
    $('.main_product .main_report .arrows .prev').on('click', function () {
        $('.swiper1').slick('slickPrev')
    });

    $('.main_product .main_report .arrows .next').on('click', function () {
        $('.swiper1').slick('slickNext')
    });
